          ...
          <li
            className={cn(
              window.location.pathname === "/" &&
                "relative bg-none text-black mix-blend-screen rounded-lg px-2 py-1 cursor-pointer before:absolute before:inset-0 before:bg-white before:mix-blend-color-burn before:rounded-lg",
            )}
          >
            <a href="/">Home</a>
          </li>
